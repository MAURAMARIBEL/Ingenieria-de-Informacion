...
preferencias2={
    'Jesica'    :{
        'Rapidos y Furiosos'            :4.5,
        'Titanic'                       :3.0,
        'No se aceptan devoluciones'    :2.0,
        'Guerra Mundial Z'              :3.0},
    'Evelyn'   :{
        'Rapidos y Furiosos'            :5.0,
        'Titanic'                       :1.0,
        'No se aceptan devoluciones'    :4.0,
        'Mi Pobre Angelito'             :3.0},
    'Yoel'      :{
        'Rapidos y Furiosos'            :4.0,
        'Titanic'                       :2.0,
        'No se aceptan devoluciones'    :3.0,
        'Guerra Mundial Z'              :3.0},
    'Kati'      :{
        'Rapidos y Furiosos'            :4.0,
        'Titanic'                       :3.0,
        'No se aceptan devoluciones'    :1.0,
        'Mi Pobre Angelito'             :4.0,
        'Guerra Mundial Z'              :2.0},
    'Fray'      :{
        'Rapidos y Furiosos'            :4.0,
        'Titanic'                       :2.0,
        'No se aceptan devoluciones'    :4.0,
        'Mi Pobre Angelito'             :4.0,
        'Guerra Mundial Z'              :4.0},
    'Mabel'     :{
        'Titanic'                       :2.0,
        'No se aceptan devoluciones'    :3.0,
        'Mi Pobre Angelito'             :4.0}
